      ...
      <View style={styles.modalContainer}>
        <View style={styles.modalContent}>
          <View style={styles.modalHeader}>
            <Text style={styles.modalTitle}>{t("profile.activityHistory")}</Text>
          ...
          {userActivity.length > 0 ? (
            ...
            <View style={styles.emptyState}>
              ...
              <Text style={styles.emptyStateText}>{t("profile.noActivityYet")}</Text>
            </View>
          )}
        </View>
      </View>
        ...
        <View style={styles.modalContent}>
          ...
          {savedReports.length > 0 ? (
              ...
              renderItem={({ item }) => (
                <TouchableOpacity 
                  ...
                  onPress={() => {
                    ...
                    navigation.navigate('DiseaseReport', { identificationData: item });
                  }}
                >
                  {item.imageUri && (
            ...
            <View style={styles.emptyState}>
              ...
              <Text style={styles.emptyStateText}>{t("profile.noReportsYet")}</Text>
            </View>
          )}
        </View>
      </View>
      ...
      <ScrollView contentContainerStyle={styles.scrollContainer}>
          ...
          <View style={styles.statsContainer}>
            ...
            <View style={styles.statItem}>
              <Text style={styles.statValue}>{
                Object.keys(savedReports.reduce((acc, report) => {
        ...
        <View style={styles.section}>
          ...
          >
            <View style={styles.menuItemLeft}>
              ...
              <Text style={styles.menuItemText}>{t("profile.activityHistory")}</Text>
            </View>
          ...
          >
            <View style={styles.menuItemLeft}>
              ...
              <Text style={styles.menuItemText}>{t("profile.savedReports")}</Text>
            </View>
            <MaterialIcons name="chevron-right" size={24} color="#ccc" />
          </TouchableOpacity>
        ...
        <View style={styles.section}>
          ...
          <View style={styles.menuItem}>
            <View style={styles.menuItemLeft}>
              <MaterialIcons name="nightlight-round" size={24} color="#148F55" />
        ...
        >
          <View style={styles.modalContainer}>
            <View style={styles.confirmModalContent}>
              <Text style={styles.confirmTitle}>{t("profile.confirmLogout")}</Text>
              <Text style={styles.confirmText}>{t("profile.logoutConfirmMessage")}</Text>
